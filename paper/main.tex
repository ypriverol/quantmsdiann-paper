...
The same recovery extends beyond bulk cell lines to another acquisition mode: a spatial Deep Visual Proteomics cohort of MYCN-amplified neuroblastoma recovered more identifications than its original \texttt{DIA-NN}~1.8.1 analysis (PXD064049; precursors 20{,}705 versus 17{,}287, $+20$\%; protein groups 3{,}099 versus 2{,}947, $+5$\%). Per-cohort completeness, peptide-per-protein distributions and accession overlap for the reanalysed cohorts are provided in Supplementary Note~6 (Figs.~S4--S10).
%% [end results]
