...
The newer 2.5.1-enterprise version increased total identifications: on HeLa Astral, total precursors rose from 22{,}531 to 25{,}145 ($+12$\%) and protein groups from 4{,}134 to 4{,}735 ($+15$\%), with the gain holding per cell (Fig.~\ref{fig:single-cell}a). On the deeper A549/H460 cohort the reanalysis reproduced the original study's Astral single-cell depth~\cite{bubis2025astral}, reaching a median of 3{,}366 protein groups per cell and up to 5{,}567 in the deepest cells, with total precursors rising from 61{,}502 to 69{,}246 ($+13$\%) and total protein groups from 7{,}007 to 7{,}426 ($+6$\%); the protein-level gain is more modest than the precursor gain, consistent with the near-saturated protein depth of this larger cohort.
