...
\begin{figure}[htbp]
  ...
  \caption[Reanalysis vs original analysis]{%
    ...
    (\textbf{b})~Precursors, restricted to the deposits whose original analysis
    was \texttt{DIA-NN} (single-cell and spatial); the OpenSWATH/PCT-SWATH
    originals report no comparable precursor count.
